package com.anbang.qipai.hongbao;
...
import com.anbang.qipai.hongbao.conf.FilePathConfig;
import com.anbang.qipai.hongbao.cqrs.c.repository.SingletonEntityFactoryImpl;
import com.anbang.qipai.hongbao.cqrs.c.service.disruptor.CoreSnapshotFactory;
import com.anbang.qipai.hongbao.cqrs.c.service.disruptor.ProcessCoreCommandEventHandler;
import com.anbang.qipai.hongbao.cqrs.c.service.disruptor.SnapshotJsonUtil;
import com.anbang.qipai.hongbao.init.InitProcessor;
...
@EnableFeignClients
@EnableScheduling
public class QipaiHongbaoApplication {
	@Autowired
	...
	public static void main(String[] args) {
		SpringApplication.run(QipaiHongbaoApplication.class, args);
	}
